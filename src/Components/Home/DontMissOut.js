        ...
        <div className=" min-h-screen flex items-center justify-center py-12 mt-10">
            <div className=" border-y border-gray-300 md:py-20 py-10 w-full">
                ...
                <div className="text-center mb-8">
                    ...
                    <h2 className="text-4xl font-extrabold text-gray-900 mb-2">Most Popular Events</h2>
                    <p className="text-gray-500 text-sm">Hand-picked experiences you'll be talking about for years.</p>
                </div>
